json.(@user, :id, :email, :name, :role, :workout_time, :workout_level, :gender, :gender_match, :description,
             :days_per_week, :cardio_per_week, :workout_preference, :attend_classes, :created_at, :device_token, :device_type)
